...
public class ImageController {
    ...
    public ImageDTO getImage(@RequestParam("title") String title) {
        ...
        imageDTO.setKeywords("站在山顶上的人们看着美丽的风景");
        imageDTO.setTitle("站在山顶上的人们看着美丽的风景");
        imageDTO.setImageUrl("https://goss.veer.com/creative/vcg/veer/1600water/veer-139261718.jpg");
        return imageDTO;
    }
